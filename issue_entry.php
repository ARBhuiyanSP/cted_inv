                            ...
                            <table class="table table-bordered" id="dynamic_field">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" name="quantity[]" id="quantity0" onchange="sum(0)" onkeyup="check_stock_quantity_validation(0)" class="form-control common_issue_quantity" step="2" min="0" required></td>
