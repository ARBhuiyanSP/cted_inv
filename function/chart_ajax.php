...
WHERE (t1.issue_date > now() - INTERVAL 11 month )  AND t1.use_in='".$use_in."'
 GROUP BY YEAR(t1.issue_date),MONTH(t1.issue_date) ORDER BY YEAR(t1.issue_date),MONTH(t1.issue_date),t1.use_in ASC ";
     $equipment_months=[];
    $equipment_amounts=[];
    $equipment_qtys=[];
